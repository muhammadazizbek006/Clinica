                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row justify-center mb-4">
                                ...
                                <button
                                    ...
                                    onClick={() => setActiveTab(2)}>Kontaktlar</button>
                            </div>
                            ...
                            <div className={`${activeTab === 1 ? 'block' : 'hidden'}`}>
                                ...
                                <form className=" flex flex-col p-4 max-w-[400px]">
                                    ...
                                    <div className='flex justify-center'>
                                        <button type="submit" className="bg-green-600 text-white px-10 py-2 rounded-2xl">yuborish</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div className={`${activeTab === 2 ? 'block' : 'hidden'}`}>
                                ...
                                <div className="flex space-x-3 py-3  lg:space-x-5">
                                    {/* vk */}
                                    <a className="bg-online-zakaz rounded-full w-8 h-8" href="https://vk.com/clinica_native" target="_blank">
                                    ...
                                    {/* telegram */}
                                    <a title="Telegramga yozing" className="flex items-center justify-center bg-online-zakaz rounded-full  w-8 h-8" href="https://t.me/clinica_native" target="_blank">
