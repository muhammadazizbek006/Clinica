                          ...
                          <Link to={`/detail/${e.name}`} className='flex'>
                            ...
                            <div className='flex flex-col'>
                              ...
                              <div className='mt-auto inline-block '>
                                  <Link to={`/detail/${e.name}`} className='text-lg font-medium bg-header py-3 px-5 inline-block  hover:bg-online-zakaz hover:text-white duration-300'>Batafsil ma'lumot</Link>
                                </div>
                            </div>
                          </Link>
                        </li>
